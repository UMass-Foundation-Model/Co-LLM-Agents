...
from agents import MCTS_agent, MCTS_vision_agent, Random_agent
...
if __name__ == '__main__':
    ...
    args.dataset_path = './dataset/data_env_set_help_filtered.pik'
    args.mode = 'hp_data_collection_all_apart'
    env_task_set = pickle.load(open(args.dataset_path, 'rb'))


    args.record_dir = f'../test_results/{args.mode}_{args.obs_type}_{args.num_per_task}'
    ...
    def env_fn(env_id):
        return UnityEnvironment(num_agents=2,
                               ...
                               observation_types=[args.obs_type, 'partial'],
    ...
    agents = [lambda x, y: MCTS_vision_agent(**args_agent1), lambda x, y: Random_agent(**args_agent2)]
    arena = ArenaMP(args.max_episode_length, id_run, env_fn, agents)

    if args.num_per_task != 20:
