...
data_root = '/work/pi_chuangg_umass_edu/zeta/tdw_perception_dataset'
backend_args = None
train_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='/work/pi_chuangg_umass_edu/zeta/tdw_perception_dataset',
        ann_file='train50PenExtend.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/work/pi_chuangg_umass_edu/zeta/tdw_perception_dataset/test50.json',
    metric=[
        'bbox',
        'segm',
    ],
...
launcher = 'none'
work_dir = './work_dirs/train50PenExtend'
